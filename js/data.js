...
const DESTINATIONS = [
  { name: 'Sigiriya', cat: 'Historical', rating: 4.9, season: 'Dec–May', desc: '5th-century rock fortress, UNESCO site with ancient frescoes and mirror wall.', budget: '$25 entry', img: IMG.sigiriya, things: ['Rock climb', 'Ancient frescoes', 'Sigiri village'] },
  { name: 'Ella', cat: 'Mountain', rating: 4.8, season: 'Year-round', desc: 'Misty highland village famed for Nine Arch Bridge, Little Adam\'s Peak and local cuisine.', budget: '$30–80/day', img: IMG.train, things: ['Nine Arch Bridge', 'Little Adam\'s Peak', 'Tea factory tours'] },
  { name: 'Mirissa', cat: 'Beach', rating: 4.7, season: 'Nov–Apr', desc: 'Golden crescent beach, legendary whale watching and laid-back surf lifestyle.', budget: '$40–100/day', img: IMG.beach2, things: ['Whale watching', 'Surfing', 'Sunset cocktails'] },
  { name: 'Yala National Park', cat: 'Wildlife', rating: 4.8, season: 'Feb–Jul', desc: 'World\'s highest leopard density. Home to elephants, crocodiles and 200+ bird species.', budget: '$50 safari', img: IMG.elephant, things: ['Leopard safari', 'Bird watching', 'Elephant herds'] },
  { name: 'Galle Fort', cat: 'Historical', rating: 4.6, season: 'Dec–Apr', desc: 'UNESCO-listed 17th century Dutch fort with colonial streets, boutique shops and cafés.', budget: '$20–60/day', img: IMG.galle, things: ['Fort walk', 'Lighthouse', 'Boutique shopping'] },
  { name: 'Nuwara Eliya', cat: 'Mountain', rating: 4.7, season: 'Jan–Apr', desc: 'Sri Lanka\'s Little England — lush tea estates, colonial bungalows and cool highland air.', budget: '$35–90/day', img: IMG.tea1, things: ['Tea factory visit', 'Gregory Lake', 'Horton Plains'] },
  { name: 'Arugam Bay', cat: 'Beach', rating: 4.6, season: 'May–Oct', desc: 'World-class surf point on the east coast with a relaxed beach village atmosphere.', budget: '$30–70/day', img: IMG.palms, things: ['Surfing', 'Crocodile safari', 'Pottuvil lagoon'] },
  { name: 'Horton Plains', cat: 'Adventure', rating: 4.7, season: 'Year-round', desc: 'Dramatic highland plateau with World\'s End cliff dropping 870 metres into jungle valley.', budget: '$25 entry', img: IMG.tea3, things: ['World\'s End hike', 'Baker\'s Falls', 'Cloud forest walk'] },
  { name: 'Trincomalee', cat: 'Beach', rating: 4.5, season: 'May–Oct', desc: 'Stunning natural harbour with turquoise waters, whale sharks, hot springs and Hindu temples.', budget: '$35–80/day', img: IMG.beach, things: ['Nilaveli beach', 'Whale shark diving', 'Hot springs'] },
  { name: 'Kandy', cat: 'Religious', rating: 4.8, season: 'Year-round', desc: 'Cultural capital with the sacred Temple of the Tooth, Kandy Lake and Esala Perahera festival.', budget: '$25–70/day', img: IMG.galle2, things: ['Temple of Tooth', 'Peradeniya Botanic Gardens', 'Kandy cultural show'] },
  { name: 'Adam\'s Peak', cat: 'Adventure', rating: 4.8, season: 'Dec–May', desc: 'Sacred pilgrimage mountain climbed by all religions. The sunrise summit view is transcendent.', budget: '$15–30', img: IMG.sigiriyaAerial, things: ['Summit sunrise hike', 'Waterfall trails', 'Tea stalls'] },
  { name: 'Bentota', cat: 'Beach', rating: 4.6, season: 'Nov–Apr', desc: 'Luxury beach resort town on the west coast — water sports, river safaris and turtle hatcheries.', budget: '$50–200/day', img: IMG.beach2, things: ['Jet skiing', 'River safari', 'Turtle hatchery'] },
];
